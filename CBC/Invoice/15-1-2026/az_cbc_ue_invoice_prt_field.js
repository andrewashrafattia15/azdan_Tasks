...
define(['N/record','N/search','N/ui/serverWidget'], function ( record,search,serverWidget) {
    ...
    const beforeLoad = (context) => {
        try {
            ...
            if (context.type === context.UserEventType.PRINT) {
                ...
                const shipToAddress = record.getText('shipaddress');
                ...
                setData(totalInEnglishWords,billToAddress,shipToAddress,customerData,subName,subAddress,subVAT,context);
            }
    ...
    const setData = (totalInEnglishWords,billToAddress,shipToAddress,customerData,subName,subAddress,subVAT,context) => {
