    ...
    const getTemplateBody = (template, header, subsidiaryData, customerData, itemLines) => {
        try {
            ...
            /** 1st Table (Customer / Quotation Info) */
                ...
                const addrLines = (customerData.customerAddress || '').split('\n').map(l => escapeXml(l.trim())).filter(Boolean).join('<br/>');

                template += '<table width="100%" style="padding-bottom:15px;">';

                template += '<tr>';
                template += '<td width="70%" style="font-size:12px;font-weight:bold;">' + escapeXml(stripIdPrefix(header.entityAltName || '')) + '</td>';
                template += '<td style="font-size:12px;font-weight:bold;">' + escapeXml(header.entityIdText || '') + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;">' + addrLines + '</td>';
                template += '<td style="font-size:9px;vertical-align:bottom;">OPPORTUNITY#: ' + escapeXml(header.opportunityTranid || '') + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;">' + escapeXml(header.entityEmail || '') + '</td>';
                template += '<td style="font-size:9px;">DATE: ' + escapeXml(formatDate(header.trandate)) + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;">' + escapeXml(header.entityPhone || '') + '</td>';
                template += '<td style="font-size:9px;">QUOTATION#: ' + escapeXml(header.tranid || '') + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;"></td>';
                template += '<td style="font-size:9px;">BRANCH: ' + escapeXml(header.location || '') + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:10px;color:#007115;">Project Name: ' + escapeXml(header.projectName || '') + '</td>';
                template += '<td style="font-size:9px;">SALESPERSON: ' + escapeXml(stripIdPrefix(header.salesrepName)) + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;">Consultant Name: ' + escapeXml(header.consultantName || '') + '</td>';
                template += '<td style="font-size:9px;">PREPARED BY: ' + escapeXml(stripIdPrefix(header.preparedBy)) + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;">Location: ' + escapeXml(header.projectLocation || '') + '</td>';
                template += '<td style="font-size:9px;">ORDER TYPE: ' + escapeXml(header.orderType || '') + '</td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td style="font-size:9px;"></td>';
                template += '<td style="font-size:9px;">CURRENCY: ' + escapeXml(header.currency || '') + '</td>';
                template += '</tr>';
            ...
            /** 2nd Table (Item Lines) */
                ...
                template += '<td width="11%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">Item Code</td>';
                template += '<td width="18%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">Description</td>';
                template += '<td width="5%"  align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">UOM</td>';
                template += '<td width="5%"  align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">QTY</td>';
                template += '<td width="10%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">Unit Rate</td>';
                template += '<td width="15%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">Total<br/>(Exc. VAT)</td>';
                template += '<td width="6%"  align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">VAT</td>';
                template += '<td width="11%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;">Total<br/>(Inc. VAT)</td>';
                template += '<td width="13%" align="center" style="font-weight:bold;vertical-align:middle;font-size:9px;color:white;background-color:#007934;border-top:1px solid #E1E1E1;border-left:1px solid #B7B7B7;border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;">Additional<br/>Note</td>';
                template += '</tr>';
                ...
                for (let i = 0; i < itemLines.length; i++) {
                    ...
                    const cur = escapeXml(header.currency);
                    template += '<tr>';
                    ...
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + escapeXml(line.itemName || '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + escapeXml(line.description || '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + escapeXml(line.units || '') + '</td>';
                    ...
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + (line.rate ? Number(line.rate).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + (line.amount ? Number(line.amount  ).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + (line.tax1amt ? Number(line.tax1amt ).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + (line.grossamt ? Number(line.grossamt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '') + '</td>';
                    template += '<td align="center" style="border-bottom:1px solid #E1E1E1;border-right:1px solid #B7B7B7;font-size:8px;">' + escapeXml(line.additionalNote || '') + '</td>';
                    template += '</tr>';
                }
            ...
            /** 3rd Table (Summary: Subtotal, Discount, VAT, Total) */
                ...
                template += '<td align="left" style="vertical-align:middle;font-size:9px;color:#737373;">' + cur + (calcSubtotal ? Number(calcSubtotal).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00') + '</td>';
                template += '<td></td>';
                template += '</tr>';
                ...
                template += '<td align="left" style="vertical-align:middle;font-size:9px;color:#737373;">' + cur + (totalDiscount ? Number(totalDiscount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00') + '</td>';
                template += '<td></td>';
                template += '</tr>';
                ...
                template += '<td align="left" style="vertical-align:middle;font-size:9px;color:#737373;">' + cur + (vatNum ? Number(vatNum).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00') + '</td>';
                template += '<td></td>';
                template += '</tr>';
                ...
                template += '<td align="left" style="vertical-align:middle;font-weight:bold;font-size:9px;background-color:#F2F2F2;">' + cur + (grandTotal ? Number(grandTotal).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00') + '</td>';
                template += '<td></td>';
                template += '</tr>';
            ...
            /** 4th Table (Payment Terms, Bank Info, T&C) */
                ...
                template += '<tr>';
                template += '<td colspan="3" style="font-size:9px;">Payment Terms: ' + escapeXml(header.terms || '') + '</td>';
                template += '<td colspan="7"></td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td colspan="3" style="font-size:9px;">Shipping Terms: ' + escapeXml(header.shippingTerms || '') + '</td>';
                template += '<td colspan="7"></td>';
                template += '</tr>';

                template += '<tr>';
                template += '<td colspan="3" style="font-size:9px;">Shipping Method: ' + escapeXml(header.shipmethod || '') + '</td>';
                template += '<td colspan="7"></td>';
                template += '</tr>';
                ...
                template += '<tr>';
                template += '<td colspan="4" align="left" style="text-align:left;vertical-align:middle;padding-top:0;padding-bottom:0;font-size:8px;">SALES PERSON EMAIL: <span style="font-size:9px;">' + escapeXml(header.salesrepEmail || '') + '</span></td>';
                ...
                template += '<tr>';
                template += '<td colspan="4" align="left" style="text-align:left;padding-top:0;font-size:8px;">SALES PERSON MOBILE: <span style="font-size:9px;">' + escapeXml(header.salesrepPhone || '') + '</span></td>';
                template += '<td colspan="6" rowspan="10" style="padding-top:0;padding-bottom:0;font-size:9px;border-bottom:1px solid #007115;">' + (header.termsConditions ? escapeXml(header.termsConditions).replace(/\n/g, '<br/>') : '') + '</td>';
                template += '</tr>';
                ...
                template += '<tr>';
                template += '<td colspan="3" style="padding-top:0;padding-bottom:0;font-size:10px;">' + escapeXml(header.subsidiaryAddr || subsidiaryData.subAddress || '') + '</td>';
                template += '<td></td>';
                template += '</tr>';
