...
define(['N/record','N/search','N/ui/serverWidget'], function ( record,search,serverWidget) {
    ...
    const beforeLoad = (context) => {
        try {
            ...
            if (context.type === context.UserEventType.PRINT) {
                ...
                log.debug('DATA :' , {salesOrderData,customerData,vendorData,vraData,subsidiaryData});
                setData(salesOrderData,customerData,vendorData,vraData,subsidiaryData,context);
            }
    ...
    const setData = (salesOrderData,customerData,vendorData,vraData,subsidiaryData,context) => {
