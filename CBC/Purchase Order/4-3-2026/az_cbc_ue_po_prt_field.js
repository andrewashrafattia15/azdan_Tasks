...
define(['N/record','N/search','N/ui/serverWidget'], function ( record,search,serverWidget) {
    ...
    const beforeLoad = (context) => {
        try {
            ...
            if (context.type === context.UserEventType.PRINT) {
                ...
                setData(totalInEnglishWords,vendorAddress,subName,subAddress,subVAT,itemsData,context);
            }
    ...
    const setData = (totalInEnglishWords,vendorAddress,subName,subAddress,subVAT,itemsData,context) => {
