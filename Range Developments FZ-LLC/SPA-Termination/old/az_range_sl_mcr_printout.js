    ...
    try {
      ...
      // // table 1
      {
        template += `<table style="width: 100%; border: 0.5pt solid ;margin-top:0 pt; border-bottom: 0pt;">
                                  ...
                                  <!-- Row 2 -->
                                  <tr>
                                      <td class="table_td_en" style="width:30%;">Identity card./ Passport number:-</td>
                                      <td class="table_td_cn" style="width:40%;"><p style="text-align:center;">${alignList(passportList,4)}</p></td>
                                  ...
                                  <tr>
                                      ...
                                      <td class="table_td_cn" style="width:40%;">${bodyFields.unitMaster}</td>
                                  ...
                                  <tr>
                                      ...
                                      <td class="table_td_cn" style="width:40%;border-bottom: 0px;"></td>
