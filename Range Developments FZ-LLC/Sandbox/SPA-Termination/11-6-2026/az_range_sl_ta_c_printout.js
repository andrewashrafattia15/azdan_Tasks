      ...
      if (context.request.method == "GET") {
        try {
          ...
          if (myRecId) {
            ...
            let secondCustomerData = getCustomerData(bodyFields.secCustomer);
  ...
  const getBody = (
    ...
    try {
      const customers = [
        ...
        secondCustomerData?.custname,
        thirdCustomerData?.custname,
        fourthCustomerData?.custname,
        fifthCustomerData?.custname,
      ];
      ...
      // // THIS AGREEMENT
      {
        template += `<p style=" align: left; font-size: 14px;"><strong>THIS AGREEMENT</strong> is made on ${escapeXml(
          bodyFields.terDate
        )} between:</p>
                      <ol type="1" style=" align: left; font-size: 14px; padding-left: 15px;">`;
        if (customerData != null && customerData != "") {
          template += `<li style="padding-bottom: 5px;">${escapeXml(
            customerData.custname
          )}, ${vowelWord(customerData.nationality)} national,`;

          if (customerData.custType == true) {
            template += `with passport number ${escapeXml(
              customerData.passportno
            )} whose address is at ${escapeXml(
              customerData.custaddress
            )} <strong>(“the Purchaser(s)”)</strong> AND</li>`;
          } else {
            template += `with registration number ${escapeXml(
        ...
        if (secondCustomerData != null && customerData != "") {
          template += `<li style="padding-bottom: 5px;">${escapeXml(
            ...
            secondCustomerData?.nationality
          )} national, with passport number ${escapeXml(
            secondCustomerData?.passportno
          )} whose address is at ${escapeXml(
            secondCustomerData?.custaddress
          )} <strong>(“the Purchaser(s)”)</strong> AND</li>`;
        }
        if (thirdCustomerData != null && customerData != "") {
          template += `<li style="padding-bottom: 5px;">${escapeXml(
            ...
            thirdCustomerData?.nationality
          )} national, with passport number ${escapeXml(
            thirdCustomerData?.passportno
          )} whose address is at ${escapeXml(
            thirdCustomerData?.custaddress
          )} <strong>(“the Purchaser(s)”)</strong> AND</li>`;
        }
        if (fourthCustomerData != null && customerData != "") {
          template += `<li style="padding-bottom: 5px;">${escapeXml(
            ...
            fourthCustomerData?.nationality
          )} national, with passport number ${escapeXml(
            fourthCustomerData?.passportno
          )} whose address is at ${escapeXml(
            fourthCustomerData?.custaddress
          )} <strong>(“the Purchaser(s)”)</strong> AND</li>`;
        }
        if (fifthCustomerData != null && customerData != "") {
          template += `<li style="padding-bottom: 5px;">${escapeXml(
            ...
            fifthCustomerData?.nationality
          )} national, with passport number ${escapeXml(
            fifthCustomerData?.passportno
          )} whose address is at ${escapeXml(
            fifthCustomerData?.custaddress
          )} <strong>(“the Purchaser(s)”)</strong> AND</li>`;
        }

        template += `<li>${escapeXml(
          bodyFields.subLegalName
        )} , a company incorporated in UAE, having correspondence address Tower 2, Boulevard Plaza, Office No 1104, 11th Floor, Burj Khalifa, Community, Downtown of PO Box 50390, Dubai, United Arab Emirates <strong>(“the Developer”)</strong></li>`;
        template += `</ol>
                        ...
                        <table style = "padding-left:18px;">
                          <tr>
                            ...
                            <td style="padding-bottom: 5px; font-size: 14px; padding-left: 10px; text-align: left;">
                              The Purchaser(s) and the Developer entered into a sale and purchase agreement dated ${escapeXml(
                                bodyFields.spaDate
                              )} (the "SPA") pursuant to which the Developer agreed to sell and the Purchaser(s) agreed to buy the property known as: ${
          bodyFields.uniteFloor.split(".")[1]
        }, Unit ${escapeXml(bodyFields.unitMaster)}, ${escapeXml(
          bodyFields.propertyName
        )}. The agreed purchase price for Unit ${escapeXml(
          bodyFields.unitMaster
        )}, ${escapeXml(bodyFields.propertyName)} was ${numberWithCommas(
          bodyFields.resUnitPrice
          ...
          bodyFields.unitMaster
                          ...
                          <tr>
                            ...
                            <td style="font-size: 14px; padding-left: 10px; text-align: left;">
                              The Purchaser(s) no longer wishes to purchase Unit ${escapeXml(
                                bodyFields.unitMaster
                              )}, ${
          bodyFields.propertyName
        } and the Developer has agreed to terminate the SPA entered into with the Purchaser(s) for the purchase of Unit ${escapeXml(
          bodyFields.unitMaster
        )}, ${bodyFields.propertyName}, subject to the terms of this Agreement.
                            </td>
                          </tr>
                        </table>
                      `;
      ...
      // // AGREED TERMS:
      {
        template += `<p style=" align: left; font-size: 14px;"><strong>AGREED TERMS:</strong></p>
                     <p style=" align: left; font-size: 14px;">The above recitals will form an integral part of this Agreement.</p>
                      ...
                      <p style=" align: left; font-size: 14px;">3.2 Upon termination of the SPA, the Purchaser(s) will have no further rights of any nature whatsoever under the SPA, including without limitation, any entitlements to any payment or compensation from the Developer, or any of its affiliates, shareholders, employees, agents or representatives.</p>
                      <p style=" align: left; font-size: 14px;">3.3 The Purchaser(s) hereby irrevocably and unconditionally release and forever discharge the Developer, its affiliates, shareholders, employees, agents and representatives from all or any actions, costs, claims, losses, liabilities, entitlements, rights and demands, whether in the United Arab Emirates or any other jurisdiction and whether or not presently known, that the Purchaser(s) or their assignees or transferees, ever had, may have or hereafter can or may have against the Developer, its affiliates, shareholders, employees, agents and representatives in relation to or arising from the performance or termination of the SPA</p>
                      <p style=" align: left; font-size: 14px;">3.4 The Purchaser(s) will indemnify and promptly reimburse the Developer, its affiliates, shareholders, employees, agents and representatives against all claims, damages, losses, liabilities, compensation, expenditures, costs, government and other fees and charges suffered or incurred as a result of the termination of the SPA or any breach of this Agreement.</p>
                      <p style=" align: left; font-size: 14px;">3.5 The Purchaser(s) agree not to make any public or private disparaging statements regarding the Developer or its affiliates, employees, or representatives, whether online or otherwise.</p>
      ...
      // // Signed by:
      {
        template += `<p style=" align: left; font-size: 14px;">Signed by:</p>
                    <p style=" align: left; font-size: 14px;">Name of the Purchaser(s): ${customerList}</p>
    ...
    try {
      ...
      if (myRecId) {
        ...
        if (searchResult != null && searchResult != "") {
          bodyFields.subsidiaryName = searchResult.getValue(
            "custrecord_ino_re_st_subsidiary"
          );
          bodyFields.terDate = searchResult.getValue(
            "custrecord_ino_re_st_date"
          );
          bodyFields.spaId = searchResult.getValue(
            "custrecord_ino_re_st_spa_number"
          );
          bodyFields.spaRes = searchResult.getValue(
            "custrecord_ino_re_st_reservation"
          );
          bodyFields.paidAmount = searchResult.getValue(
            "custrecord_ino_re_st_paid_amount"
          );
          bodyFields.amount = searchResult.getValue(
            "custrecord_az_rng_st_amount"
          );
          bodyFields.propertyName = searchResult.getText(
            "custrecord_ino_re_st_property"
          );
          bodyFields.unitMaster = searchResult.getText(
            "custrecord_ino_re_st_unit_master"
          );
          bodyFields.customer = searchResult.getValue(
            "custrecord_ino_re_st_customer"
          );
          bodyFields.secCustomer = searchResult.getValue(
            "custrecord_ino_re_st_secondery_customer"
          );
          bodyFields.thirdCustomer = searchResult.getValue(
            "custrecord_ino_re_st_third_customer"
          );
          bodyFields.fourthCustomer = searchResult.getValue(
            "custrecord_ino_re_st_fourth_customer"
          );
          bodyFields.fifthCustomer = searchResult.getValue(
            "custrecord_ino_re_st_fifth_customer"
          );
      ...
      if (bodyFields.subsidiaryName) {
        const fieldsSearch = search
          .create({
            type: "subsidiary",
            columns: ["legalname"],
            filters: [[["internalid", "is", bodyFields.subsidiaryName]]],
          })
          .run()
          .getRange(0, 1);
      ...
      if (bodyFields.spaId) {
        const fieldsSearch = search
          .create({
            type: "salesorder",
            columns: ["trandate"],
            filters: [[["internalid", "is", bodyFields.spaId]]],
          })
          .run()
          .getRange(0, 1);
      ...
      if (bodyFields.unitMaster) {
        const fieldsSearch = search
          .create({
            ...
            columns: ["custrecord_ino_re_um_floor"],
            filters: [[["name", "is", bodyFields.unitMaster]]],
          })
          .run()
          .getRange(0, 1);
        ...
        if (searchResult != null && searchResult != "") {
          bodyFields.uniteFloor = searchResult.getText(
      ...
      if (bodyFields.spaRes) {
        const fieldsSearch = search
          .create({
            ...
            filters: [[["internalid", "is", bodyFields.spaRes]]],
          })
          .run()
          .getRange(0, 1);
      ...
      if (myRecId) {
        const fieldsSearch = search
          .create({
            ...
            columns: ["custrecord_ino_re_tf_amount"],
            filters: [
        ...
        if (fieldsSearch != null && fieldsSearch != "") {
          ...
          for (let i = 0; i < fieldsSearch.length; i++) {
            feesSum.push(
              fieldsSearch[i].getValue("custrecord_ino_re_tf_amount")
            );
          }
          const totalFees = feesSum.map(Number);
          bodyFields.terminationFees = totalFees.reduce(
            (acc, val) => acc + val,
            0
          );
        }
  ...
  const getCustomerData = (custID) => {
    try {
      ...
      if (custSearch != null && custSearch != "") {
        ...
        const custType = custSearch[0].getValue("isperson");
