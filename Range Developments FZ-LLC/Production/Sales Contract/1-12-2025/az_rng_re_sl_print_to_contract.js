    ...
    try {
      ...
      // // page ii
      {
        ...
        // // 6.	Payment Schedule
        {
          ...
          const widthRemarks = contractData.subsidiary == 2||3||8 ? "20%" : "0%";
...
log.debug("contractData.subsidiary",contractData.subsidiary)
          if (contractData.subsidiary == 2||contractData.subsidiary == 3||contractData.subsidiary == 8) {
          ...
          for (i = 0; i < paymentPlanData.res.length; i++) {
            if (paymentPlanData.res[i].isInActive == false) {
              ...
              else if(contractData.subsidiary == 8){cutoffDate= new Date('2027-12-31');}
