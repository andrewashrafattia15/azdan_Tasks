...
define(['N/file', 'N/render', 'N/search', 'N/format', 'N/record','N/runtime'], function (file, render, search, format, record,runtime) {
        ...
        try {
            ...
            const salesFile = savePdfFile(template, 'Project_Sales_', 21073, yesterday)
             ...
             if (recordId) {
                ...
                CreateDailyReportRecord(movmentFile, salesFile);
            }
    ...
    const getMovmentHeader = (date, dayNumber) => {
        try {
            ...
            template += '#page2 { header:nlheadersec; header-height:8%; }'
            template += '</style>'
            template += '</head>'
        ...
        try {
            //table 1 (Beach House)
            {
                ...
                template += `
                            ...
                            <tr>
                            <td colspan="6" style="background-color: #e3e3e3;color: #333333;border-right:1px;border-top:1px;border-bottom:0px;align:center;">The Beach House</td>
                            </tr>
                            <tr>
                            ...
                            <th style="width: 16%">Sum of Payments Amount</th>
                            <th style="width: 14%;border-right:1px;">Payment Method</th>
                            </tr>`
                if (tBHData.length == 0) {
                    template += '<tr><td style="border-right:1px;" colspan="6">No Movment For The Day</td></tr>';
                } else {
                    tBHData.forEach(object => {
                        template += `<tr>
                                    ...
                                    <td style="border-right:1px;">${escapeXML(object.paymentMethod)}</td>
                                    </tr>`;
                    });
                }
                template += `
            ...
            //table 2 (Beach Residences)
            {
                ...
                template += `
                            <table style="width: 100%;padding-bottom:25px;">
                            <tr>
                            <td colspan="6" style="background-color: #e3e3e3;color: #333333;border-right:1px;border-top:1px;border-bottom:0px;align:center;">The Beach Residences</td>
                            </tr>
                            <tr>
                            <th style="width: 8%">Unit</th>
                            <th style="width: 20%">Customer</th>
            ...
            //table 3 (Beach Vista)
            {
                template += `
                            <table style="width: 100%;padding-bottom:25px;">
                            <tr>
                            <td colspan="6" style="background-color: #e3e3e3;color: #333333;border-right:1px;border-top:1px;border-bottom:0px;align:center;">The Beach Vista</td>
                            </tr>
                            <tr>
                            <th style="width: 8%">Unit</th>
                            <th style="width: 20%">Customer</th>
            ...
            //table 4 (Island Heights)
            {
                template += `
                            <table style="width: 100%;padding-bottom:25px;">
                            <tr>
                            <td colspan="6" style="background-color: #e3e3e3;color: #333333;border-right:1px;border-top:1px;border-bottom:0px;align:center;">Island Heights</td>
                            </tr>
                            <tr>
                            <th style="width: 8%">Unit</th>
                            <th style="width: 20%">Customer</th>
            ...
            template += `<p style = "font-size: 10pt;page-break-before: always;">Please find the cash balances as of ${date}:</p>`
        ...
        try {
            ...
            if (searchResult != null && searchResult != '') {
                searchResult.forEach((result) => {
                    ...
                    //   log.debug ('islandheights',salesData.islandHeights)
                    //   log.debug ('beachVista',salesData.beachVista)
                    //   log.debug ('beachResidences',salesData.beachResidences)
                    //   log.debug ('beachHouse',salesData.beachHouse)
                    ...
                    subsidiaryData.count++;
                    // log.debug("subsidiaryData",subsidiaryData)
    ...
    const CreateDailyReportRecord = (MovmentFile, salesFile) => {
        try {
