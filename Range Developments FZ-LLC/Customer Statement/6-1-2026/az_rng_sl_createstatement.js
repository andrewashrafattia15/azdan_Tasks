            ...
            try {
                ...
                var srch2 = s.create({
                    ...
                    filters: [
                        ...
                        ['custrecord_ino_re_ppa_property', s.Operator.IS, propertyId],'and',
                        ['custrecord_ino_re_ppa_customerreceipt.custrecord_ino_re_cr_status', s.Operator.ANYOF, '2']
                    ]
                });
                ...
                if (reciptId) {
                    let reciptRec = s.create({
                        ...
                        filters:[ 
                            ...
                            ['internalid', s.Operator.IS, reciptId]
                        ],
                        columns: [
                    ...
                    if (searchResult && searchResult.length > 0) {
                        for (var i = 0; i < searchResult.length; i++) {
                            ...
                            let statusText = searchResult[0].getText('custrecord_ino_re_cr_status') || '';
                            log.debug('Receipt Status', `ID: ${reciptId}, Status: ${statusText}`);
