...
define(['N/encode', 'N/record'], function (encode, record) {
        ...
        try {
            ...
            if (Type == 'create' || Type == 'edit' || Type == 'xedit') {
                ...
                if (subsidiary) {
                    if(subsidiary == 7)
                    {
                        const landlord_id = Record.getValue("custbody_ino_pms_landlord")
    ...
    const getInvoiceData = (recType, recId) => {
        try {
            ...
            const subsidiary = (subsidiaryID == 7) ? myRec.getText('custbody_ino_pms_landlord') : myRec.getText('subsidiary');
