        ...
        try {
            if (context.type === context.UserEventType.PRINT) {
                ...
                for (let i = 0; i < tuitionIntallmentDetails.length; i++) {
                    ...
                    const date = tuitionIntallmentDetails[i].date;
    ...
    const getTuitionIntallmentDetails = (recId)=>{
        try {
            ...
            const recSearch = search.create({
                ...
                filters: [
                    ['custrecord_az_acs_sales_order', search.Operator.IS, recId],'AND',
                ...
                columns: [
                    ...
                    'custrecord_az_acs_current_date'
                ],
            });
            ...
            if (searchResult != null && searchResult != '') {
                ...
                for (let i = 0; i < searchResult.length; i++) {
                    ...
                    const date = searchResult[i].getValue('custrecord_az_acs_current_date');
